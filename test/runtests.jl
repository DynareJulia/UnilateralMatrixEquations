...
using UnilateralQuadraticMatrixEquations: solve!, solve, Workspace, CRSolverWs, GSSolverWs
using UnilateralQuadraticMatrixEquations.SparseArrays
const UQME = UnilateralQuadraticMatrixEquations
using Random
using Test
        ...
        @testset "$i" begin
            ...
            @testset "GS Solve" begin
                @testset "d, e" begin
                    ...
                    ws1 = GSSolverWs(a0)
                    @test_throws UQME.UnstableSystemException solve!(ws1, d, e; tolerance=tolerance)
                    
                    nstable1 = nstable - 1
                    a0 = Matrix([-e_orig[:, 1:nstable1] zeros(n, n-nstable1)])
                    ws1 = GSSolverWs(a0)
                    @test_throws UQME.UndeterminateSystemException solve!(ws1, d, e; tolerance=tolerance)
                end
            ...
            @testset "CRSolverWs Reduction" begin
                @testset "dense" begin
                    ...
                    ws2 = CRSolverWs(a0)
                    @test_throws UQME.UnstableSystemException solve!(ws2, a0, a1, a2, tolerance=1e-8, max_iterations=500)
                    ...
                    ws2 = CRSolverWs(a0)
                    @test_throws UQME.UndeterminateSystemException solve!(ws2, a0, a1, a2, tolerance=1e-8, max_iterations=500)
                end
                @testset "sparse" begin
                    ...
                    @test_throws UQME.UnstableSystemException solve!(ws2, a0, a1, a2, tolerance=1e-12, max_iterations=500)
                    ...
                    ws2 = CRSolverWs(a0)
                    @test_throws UQME.UndeterminateSystemException solve!(ws2,  a0, a1, a2, tolerance=1e-12, max_iterations=500)
                end
            end
        end
