module UnilateralQuadraticMatrixEquations
...
```jldoctest
julia> using UnilateralQuadraticMatrixEquations

julia> const PME = UnilateralQuadraticMatrixEquations
UnilateralQuadraticMatrixEquations
...
UnilateralQuadraticMatrixEquations.GSSolverWs{Float64}
...
julia> ws2 = PME.Workspace(a0, a1, a2)
UnilateralQuadraticMatrixEquations.CRSolverWs{Float64, FastLapackInterface.LUWs, SparseMatrixCSC{Float64, Int64}}
